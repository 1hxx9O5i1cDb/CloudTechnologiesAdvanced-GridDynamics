...
#     source = "./google_compute_global_address"
#     network_uri = module.google_compute_network.network_uri
#     depends_on = [ module.google_compute_firewall ]
# }

# module "google_service_networking_connection" {
#     source = "./google_service_networking_connection"
#     network_uri = module.google_compute_network.network_uri
#     address_name = module.google_compute_global_address.address_name
#     depends_on = [ module.google_compute_global_address ]
# }
